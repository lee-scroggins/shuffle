 ...
 * shuffle for arrays of all primitive data types, as well as {@link Object}.  Shuffling is done
...
public class Shuffler {
  ...
  /**
   * Initialized this instance, using the provided source of randomness.
   *
